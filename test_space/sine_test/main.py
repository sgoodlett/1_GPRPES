...
input_object.set_keyword({'training_points':500000})
input_object.set_keyword({'sampling':'random'})
input_object.set_keyword({'hp_maxit':10})
input_object.set_keyword({'rseed':0})

svigp = peslearn.ml.SVIGP("sine.dat", input_object, molecule_type='A2', batchsize = 1000, inducing_n = 500, max_iter = 100)
